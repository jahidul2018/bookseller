                                    ...
                                    <div class="product__big__images">
                                        <div class="portfolio-full-image tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="img-tab-2">
                                                <img src="{{ asset('frontend/images/product-2/big-img/2.jpg') }}" alt="full-image">
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="img-tab-3">
                                                <img src="{{ asset('frontend/images/product-2/big-img/3.jpg') }}" alt="full-image">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="product__small__images" role="tablist">
                                        <li role="presentation" class="pot-small-img active">
                                            <a href="#img-tab-1" role="tab" data-toggle="tab">
                                                <img src="{{ asset('frontend/images/product-2/sm-img-3/3.jpg') }}" alt="small-image">
                                            </a>
                                        </li>
                                        <li role="presentation" class="pot-small-img">
                                            <a href="#img-tab-2" role="tab" data-toggle="tab">
                                                <img src="{{ asset('frontend/images/product-2/sm-img-3/1.jpg') }}" alt="small-image">
                                            </a>
                                        </li>
                                        <li role="presentation" class="pot-small-img">
                                            <a href="#img-tab-3" role="tab" data-toggle="tab">
                                                <img src="{{ asset('frontend/images/product-2/sm-img-3/2.jpg') }}" alt="small-image">
                                            </a>
                                        </li>
                                    </ul>
                                    <!-- End Small images -->
                                ...
                                <div class="ht__product__dtl">
                                    ...
                                    <div class="ht__pro__desc">
                                        ...
                                        <div class="fr__list__btn">
                                            <a class="fr__btn" href=" {{ route('cart') }}">Add To Cart</a>
                                        </div>
